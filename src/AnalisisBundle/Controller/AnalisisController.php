...
namespace AnalisisBundle\Controller;

use AnalisisBundle\Entity\Analisis;
...
class AnalisisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $analises = $em->getRepository('AnalisisBundle:Analisis')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AnalisisBundle\Form\AnalisisType', $analisis);
    ...
    {
        $deleteForm = $this->createDeleteForm($analisis);
        $editForm = $this->createForm('AnalisisBundle\Form\AnalisisType', $analisis);
